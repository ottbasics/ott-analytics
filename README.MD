...
Use this if you want the data without the visual overlay:
...
const analytics = new OTTAnalytics({ debug: true });
...
| **`resolution`**      | `string`  | Current playback resolution (e.g., `"1920x1080"`).    |
